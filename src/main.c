...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOD, MUX0_A0_Pin|MUX0_A1_Pin|MUX0_A2_Pin|MUX1_A0_Pin
                          |MUX1_A1_Pin|MUX1_A2_Pin|MUX0_RST_Pin|MUX1_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : USER0_Pin USER1_Pin USER2_Pin USER3_Pin
                           USER4_Pin */
  ...
  /*Configure GPIO pins : MUX0_A0_Pin MUX0_A1_Pin MUX0_A2_Pin MUX1_A0_Pin
                           MUX1_A1_Pin MUX1_A2_Pin */
  GPIO_InitStruct.Pin = MUX0_A0_Pin|MUX0_A1_Pin|MUX0_A2_Pin|MUX1_A0_Pin
                          |MUX1_A1_Pin|MUX1_A2_Pin;
  ...
  /*Configure GPIO pins : MUX0_RST_Pin MUX1_RST_Pin */
  GPIO_InitStruct.Pin = MUX0_RST_Pin|MUX1_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
